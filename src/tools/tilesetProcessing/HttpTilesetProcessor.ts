 ...
 * @internal
 */
export class HttpTilesetProcessor extends TilesetProcessor {
  /**
  ...
  private async processExplicitTileContentEntries(
    ...
    const contents = HttpTilesetProcessor.getTileContents(tile);
    ...
    HttpTilesetProcessor.updateTileContent(tile, targetContentUris);
  }
